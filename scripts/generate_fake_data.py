...
def main():
    parser = argparse.ArgumentParser(
        description="Generate synthetic data for the platform."
    )
    parser.add_argument(
        "--users", type=int, default=100, help="Number of users to generate."
    )
    parser.add_argument(
        "--datasets", type=int, default=50, help="Number of datasets to generate."
    )
